...
CIMGUI_API ImGuiID cimgui::ImHashData(const void* data, size_t data_size)
{
    return ::ImHashData(data, data_size);
}

CIMGUI_API ImGuiID cimgui::ImHashDataEx(const void* data, size_t data_size, ImGuiID seed)
{
    return ::ImHashData(data, data_size, seed);
}

CIMGUI_API ImGuiID cimgui::ImHashStr(const char* data)
{
    return ::ImHashStr(data);
}

CIMGUI_API ImGuiID cimgui::ImHashStrEx(const char* data, size_t data_size, ImGuiID seed)
{
    return ::ImHashStr(data, data_size, seed);
}

CIMGUI_API ImU32 cimgui::ImAlphaBlendColors(ImU32 col_a, ImU32 col_b)
{
    return ::ImAlphaBlendColors(col_a, col_b);
}

CIMGUI_API bool         cimgui::ImIsPowerOfTwo(int v)
{
    return ::ImIsPowerOfTwo(v);
}

CIMGUI_API bool         cimgui::ImIsPowerOfTwoImU64(ImU64 v)
{
    return ::ImIsPowerOfTwo(v);
}

CIMGUI_API int          cimgui::ImUpperPowerOfTwo(int v)
{
    return ::ImUpperPowerOfTwo(v);
}

CIMGUI_API unsigned int cimgui::ImCountSetBits(unsigned int v)
{
    return ::ImCountSetBits(v);
}

CIMGUI_API int         cimgui::ImStricmp(const char* str1, const char* str2)
{
    return ::ImStricmp(str1, str2);
}

CIMGUI_API int         cimgui::ImStrnicmp(const char* str1, const char* str2, size_t count)
{
    return ::ImStrnicmp(str1, str2, count);
}

CIMGUI_API void        cimgui::ImStrncpy(char* dst, const char* src, size_t count)
{
    ::ImStrncpy(dst, src, count);
}

CIMGUI_API char*       cimgui::ImStrdup(const char* str)
{
    return ::ImStrdup(str);
}

CIMGUI_API char*       cimgui::ImStrdupcpy(char* dst, size_t* p_dst_size, const char* str)
{
    return ::ImStrdupcpy(dst, p_dst_size, str);
}

CIMGUI_API const char* cimgui::ImStrchrRange(const char* str_begin, const char* str_end, char c)
{
    return ::ImStrchrRange(str_begin, str_end, c);
}

CIMGUI_API const char* cimgui::ImStreolRange(const char* str, const char* str_end)
{
    return ::ImStreolRange(str, str_end);
}

CIMGUI_API const char* cimgui::ImStristr(const char* haystack, const char* haystack_end, const char* needle, const char* needle_end)
{
    return ::ImStristr(haystack, haystack_end, needle, needle_end);
}

CIMGUI_API void        cimgui::ImStrTrimBlanks(char* str)
{
    ::ImStrTrimBlanks(str);
}

CIMGUI_API const char* cimgui::ImStrSkipBlank(const char* str)
{
    return ::ImStrSkipBlank(str);
}

CIMGUI_API int         cimgui::ImStrlenW(const ImWchar* str)
{
    return ::ImStrlenW(str);
}

CIMGUI_API const char* cimgui::ImStrbol(const char* buf_mid_line, const char* buf_begin)
{
    return ::ImStrbol(buf_mid_line, buf_begin);
}

CIMGUI_API char        cimgui::ImToUpper(char c)
{
    return ::ImToUpper(c);
}

CIMGUI_API bool        cimgui::ImCharIsBlankA(char c)
{
    return ::ImCharIsBlankA(c);
}

CIMGUI_API bool        cimgui::ImCharIsBlankW(unsigned int c)
{
    return ::ImCharIsBlankW(c);
}

CIMGUI_API bool        cimgui::ImCharIsXdigitA(char c)
{
    return ::ImCharIsXdigitA(c);
}

CIMGUI_API int         cimgui::ImFormatString(char* buf, size_t buf_size, const char* fmt, ...)
{
    va_list args;
    va_start(args, fmt);
...
CIMGUI_API int         cimgui::ImFormatStringV(char* buf, size_t buf_size, const char* fmt, va_list args)
{
    return ::ImFormatStringV(buf, buf_size, fmt, args);
}

CIMGUI_API void        cimgui::ImFormatStringToTempBuffer(const char** out_buf, const char** out_buf_end, const char* fmt, ...)
{
    va_list args;
    va_start(args, fmt);
...
CIMGUI_API void        cimgui::ImFormatStringToTempBufferV(const char** out_buf, const char** out_buf_end, const char* fmt, va_list args)
{
    ::ImFormatStringToTempBufferV(out_buf, out_buf_end, fmt, args);
}

CIMGUI_API const char* cimgui::ImParseFormatFindStart(const char* format)
{
    return ::ImParseFormatFindStart(format);
}

CIMGUI_API const char* cimgui::ImParseFormatFindEnd(const char* format)
{
    return ::ImParseFormatFindEnd(format);
}

CIMGUI_API const char* cimgui::ImParseFormatTrimDecorations(const char* format, char* buf, size_t buf_size)
{
    return ::ImParseFormatTrimDecorations(format, buf, buf_size);
}

CIMGUI_API void        cimgui::ImParseFormatSanitizeForPrinting(const char* fmt_in, char* fmt_out, size_t fmt_out_size)
{
    ::ImParseFormatSanitizeForPrinting(fmt_in, fmt_out, fmt_out_size);
}

CIMGUI_API const char* cimgui::ImParseFormatSanitizeForScanning(const char* fmt_in, char* fmt_out, size_t fmt_out_size)
{
    return ::ImParseFormatSanitizeForScanning(fmt_in, fmt_out, fmt_out_size);
}

CIMGUI_API int         cimgui::ImParseFormatPrecision(const char* format, int default_value)
{
    return ::ImParseFormatPrecision(format, default_value);
}

CIMGUI_API const char* cimgui::ImTextCharToUtf8(char out_buf[5], unsigned int c)
{
    return ::ImTextCharToUtf8(out_buf, c);
}

CIMGUI_API int         cimgui::ImTextStrToUtf8(char* out_buf, int out_buf_size, const ImWchar* in_text, const ImWchar* in_text_end)
{
    return ::ImTextStrToUtf8(out_buf, out_buf_size, in_text, in_text_end);
}

CIMGUI_API int         cimgui::ImTextCharFromUtf8(unsigned int* out_char, const char* in_text, const char* in_text_end)
{
    return ::ImTextCharFromUtf8(out_char, in_text, in_text_end);
}

CIMGUI_API int         cimgui::ImTextStrFromUtf8(ImWchar* out_buf, int out_buf_size, const char* in_text, const char* in_text_end)
{
    return ::ImTextStrFromUtf8(out_buf, out_buf_size, in_text, in_text_end);
}

CIMGUI_API int         cimgui::ImTextStrFromUtf8Ex(ImWchar* out_buf, int out_buf_size, const char* in_text, const char* in_text_end, const char** in_remaining)
{
    return ::ImTextStrFromUtf8(out_buf, out_buf_size, in_text, in_text_end, in_remaining);
}

CIMGUI_API int         cimgui::ImTextCountCharsFromUtf8(const char* in_text, const char* in_text_end)
{
    return ::ImTextCountCharsFromUtf8(in_text, in_text_end);
}

CIMGUI_API int         cimgui::ImTextCountUtf8BytesFromChar(const char* in_text, const char* in_text_end)
{
    return ::ImTextCountUtf8BytesFromChar(in_text, in_text_end);
}

CIMGUI_API int         cimgui::ImTextCountUtf8BytesFromStr(const ImWchar* in_text, const ImWchar* in_text_end)
{
    return ::ImTextCountUtf8BytesFromStr(in_text, in_text_end);
}

CIMGUI_API const char* cimgui::ImTextFindPreviousUtf8Codepoint(const char* in_text_start, const char* in_text_curr)
{
    return ::ImTextFindPreviousUtf8Codepoint(in_text_start, in_text_curr);
}

CIMGUI_API int         cimgui::ImTextCountLines(const char* in_text, const char* in_text_end)
{
...
CIMGUI_API ImFileHandle cimgui::ImFileOpen(const char* __unnamed_arg0__, const char* __unnamed_arg1__)
{
    return ::ImFileOpen(__unnamed_arg0__, __unnamed_arg1__);
}

CIMGUI_API bool         cimgui::ImFileClose(ImFileHandle __unnamed_arg0__)
{
    return ::ImFileClose(__unnamed_arg0__);
}

CIMGUI_API ImU64        cimgui::ImFileGetSize(ImFileHandle __unnamed_arg0__)
{
    return ::ImFileGetSize(__unnamed_arg0__);
}

CIMGUI_API ImU64        cimgui::ImFileRead(void* __unnamed_arg0__, ImU64 __unnamed_arg1__, ImU64 __unnamed_arg2__, ImFileHandle __unnamed_arg3__)
{
    return ::ImFileRead(__unnamed_arg0__, __unnamed_arg1__, __unnamed_arg2__, __unnamed_arg3__);
}

CIMGUI_API ImU64        cimgui::ImFileWrite(const void* __unnamed_arg0__, ImU64 __unnamed_arg1__, ImU64 __unnamed_arg2__, ImFileHandle __unnamed_arg3__)
{
...
CIMGUI_API ImFileHandle cimgui::ImFileOpen(const char* filename, const char* mode)
{
    return ::ImFileOpen(filename, mode);
}

CIMGUI_API bool         cimgui::ImFileClose(ImFileHandle file)
{
    return ::ImFileClose(file);
}

CIMGUI_API ImU64        cimgui::ImFileGetSize(ImFileHandle file)
{
    return ::ImFileGetSize(file);
}

CIMGUI_API ImU64        cimgui::ImFileRead(void* data, ImU64 size, ImU64 count, ImFileHandle file)
{
    return ::ImFileRead(data, size, count, file);
}

CIMGUI_API ImU64        cimgui::ImFileWrite(const void* data, ImU64 size, ImU64 count, ImFileHandle file)
{
...
CIMGUI_API void* cimgui::ImFileLoadToMemory(const char* filename, const char* mode)
{
    return ::ImFileLoadToMemory(filename, mode);
}

CIMGUI_API void* cimgui::ImFileLoadToMemoryEx(const char* filename, const char* mode, size_t* out_file_size, int padding_bytes)
{
...
CIMGUI_API float  cimgui::ImPow(float x, float y)
{
    return ::ImPow(x, y);
}

CIMGUI_API double cimgui::ImPowDouble(double x, double y)
{
    return ::ImPow(x, y);
}

CIMGUI_API float  cimgui::ImLog(float x)
{
    return ::ImLog(x);
}

CIMGUI_API double cimgui::ImLogDouble(double x)
{
    return ::ImLog(x);
}

CIMGUI_API int    cimgui::ImAbs(int x)
{
    return ::ImAbs(x);
}

CIMGUI_API float  cimgui::ImAbsFloat(float x)
{
    return ::ImAbs(x);
}

CIMGUI_API double cimgui::ImAbsDouble(double x)
{
    return ::ImAbs(x);
}

CIMGUI_API float  cimgui::ImSign(float x)
{
    return ::ImSign(x);
}

CIMGUI_API double cimgui::ImSignDouble(double x)
{
    return ::ImSign(x);
}
...
CIMGUI_API float cimgui::ImRsqrt(float x)
{
    return ::ImRsqrt(x);
}
...
CIMGUI_API float cimgui::ImRsqrtFloat(float x)
{
    return ::ImRsqrt(x);
}
...
CIMGUI_API double cimgui::ImRsqrtDouble(double x)
{
    return ::ImRsqrt(x);
}
...
CIMGUI_API cimgui::ImVec2 cimgui::ImMin(cimgui::ImVec2 lhs, cimgui::ImVec2 rhs)
{
    return ConvertFromCPP_ImVec2(::ImMin(ConvertToCPP_ImVec2(lhs), ConvertToCPP_ImVec2(rhs)));
}

CIMGUI_API cimgui::ImVec2 cimgui::ImMax(cimgui::ImVec2 lhs, cimgui::ImVec2 rhs)
{
    return ConvertFromCPP_ImVec2(::ImMax(ConvertToCPP_ImVec2(lhs), ConvertToCPP_ImVec2(rhs)));
}

CIMGUI_API cimgui::ImVec2 cimgui::ImClamp(cimgui::ImVec2 v, cimgui::ImVec2 mn, cimgui::ImVec2 mx)
{
    return ConvertFromCPP_ImVec2(::ImClamp(ConvertToCPP_ImVec2(v), ConvertToCPP_ImVec2(mn), ConvertToCPP_ImVec2(mx)));
}

CIMGUI_API cimgui::ImVec2 cimgui::ImLerp(cimgui::ImVec2 a, cimgui::ImVec2 b, float t)
{
    return ConvertFromCPP_ImVec2(::ImLerp(ConvertToCPP_ImVec2(a), ConvertToCPP_ImVec2(b), t));
}

CIMGUI_API cimgui::ImVec2 cimgui::ImLerpImVec2(cimgui::ImVec2 a, cimgui::ImVec2 b, cimgui::ImVec2 t)
{
    return ConvertFromCPP_ImVec2(::ImLerp(ConvertToCPP_ImVec2(a), ConvertToCPP_ImVec2(b), ConvertToCPP_ImVec2(t)));
}

CIMGUI_API cimgui::ImVec4 cimgui::ImLerpImVec4(cimgui::ImVec4 a, cimgui::ImVec4 b, float t)
{
    return ConvertFromCPP_ImVec4(::ImLerp(ConvertToCPP_ImVec4(a), ConvertToCPP_ImVec4(b), t));
}

CIMGUI_API float  cimgui::ImSaturate(float f)
{
    return ::ImSaturate(f);
}

CIMGUI_API float  cimgui::ImLengthSqr(cimgui::ImVec2 lhs)
{
    return ::ImLengthSqr(ConvertToCPP_ImVec2(lhs));
}

CIMGUI_API float  cimgui::ImLengthSqrImVec4(cimgui::ImVec4 lhs)
{
    return ::ImLengthSqr(ConvertToCPP_ImVec4(lhs));
}

CIMGUI_API float  cimgui::ImInvLength(cimgui::ImVec2 lhs, float fail_value)
{
    return ::ImInvLength(ConvertToCPP_ImVec2(lhs), fail_value);
}

CIMGUI_API float  cimgui::ImTrunc(float f)
{
    return ::ImTrunc(f);
}

CIMGUI_API cimgui::ImVec2 cimgui::ImTruncImVec2(cimgui::ImVec2 v)
{
    return ConvertFromCPP_ImVec2(::ImTrunc(ConvertToCPP_ImVec2(v)));
}

CIMGUI_API float  cimgui::ImFloor(float f)
{
    return ::ImFloor(f);
}

CIMGUI_API cimgui::ImVec2 cimgui::ImFloorImVec2(cimgui::ImVec2 v)
{
    return ConvertFromCPP_ImVec2(::ImFloor(ConvertToCPP_ImVec2(v)));
}

CIMGUI_API int    cimgui::ImModPositive(int a, int b)
{
    return ::ImModPositive(a, b);
}

CIMGUI_API float  cimgui::ImDot(cimgui::ImVec2 a, cimgui::ImVec2 b)
{
    return ::ImDot(ConvertToCPP_ImVec2(a), ConvertToCPP_ImVec2(b));
}

CIMGUI_API cimgui::ImVec2 cimgui::ImRotate(cimgui::ImVec2 v, float cos_a, float sin_a)
{
    return ConvertFromCPP_ImVec2(::ImRotate(ConvertToCPP_ImVec2(v), cos_a, sin_a));
}

CIMGUI_API float  cimgui::ImLinearSweep(float current, float target, float speed)
{
    return ::ImLinearSweep(current, target, speed);
}

CIMGUI_API float  cimgui::ImLinearRemapClamp(float s0, float s1, float d0, float d1, float x)
{
    return ::ImLinearRemapClamp(s0, s1, d0, d1, x);
}

CIMGUI_API cimgui::ImVec2 cimgui::ImMul(cimgui::ImVec2 lhs, cimgui::ImVec2 rhs)
{
    return ConvertFromCPP_ImVec2(::ImMul(ConvertToCPP_ImVec2(lhs), ConvertToCPP_ImVec2(rhs)));
}

CIMGUI_API bool   cimgui::ImIsFloatAboveGuaranteedIntegerPrecision(float f)
{
    return ::ImIsFloatAboveGuaranteedIntegerPrecision(f);
}

CIMGUI_API float  cimgui::ImExponentialMovingAverage(float avg, float sample, int n)
{
    return ::ImExponentialMovingAverage(avg, sample, n);
}

CIMGUI_API cimgui::ImVec2 cimgui::ImBezierCubicCalc(cimgui::ImVec2 p1, cimgui::ImVec2 p2, cimgui::ImVec2 p3, cimgui::ImVec2 p4, float t)
{
...
CIMGUI_API cimgui::ImVec2 cimgui::ImBezierCubicClosestPoint(cimgui::ImVec2 p1, cimgui::ImVec2 p2, cimgui::ImVec2 p3, cimgui::ImVec2 p4, cimgui::ImVec2 p, int num_segments)
{
...
CIMGUI_API cimgui::ImVec2 cimgui::ImBezierCubicClosestPointCasteljau(cimgui::ImVec2 p1, cimgui::ImVec2 p2, cimgui::ImVec2 p3, cimgui::ImVec2 p4, cimgui::ImVec2 p, float tess_tol)
{
...
CIMGUI_API cimgui::ImVec2 cimgui::ImBezierQuadraticCalc(cimgui::ImVec2 p1, cimgui::ImVec2 p2, cimgui::ImVec2 p3, float t)
{
...
CIMGUI_API cimgui::ImVec2 cimgui::ImLineClosestPoint(cimgui::ImVec2 a, cimgui::ImVec2 b, cimgui::ImVec2 p)
{
    return ConvertFromCPP_ImVec2(::ImLineClosestPoint(ConvertToCPP_ImVec2(a), ConvertToCPP_ImVec2(b), ConvertToCPP_ImVec2(p)));
}

CIMGUI_API bool   cimgui::ImTriangleContainsPoint(cimgui::ImVec2 a, cimgui::ImVec2 b, cimgui::ImVec2 c, cimgui::ImVec2 p)
{
    return ::ImTriangleContainsPoint(ConvertToCPP_ImVec2(a), ConvertToCPP_ImVec2(b), ConvertToCPP_ImVec2(c), ConvertToCPP_ImVec2(p));
}

CIMGUI_API cimgui::ImVec2 cimgui::ImTriangleClosestPoint(cimgui::ImVec2 a, cimgui::ImVec2 b, cimgui::ImVec2 c, cimgui::ImVec2 p)
{
...
CIMGUI_API void   cimgui::ImTriangleBarycentricCoords(cimgui::ImVec2 a, cimgui::ImVec2 b, cimgui::ImVec2 c, cimgui::ImVec2 p, float* out_u, float* out_v, float* out_w)
{
...
CIMGUI_API float  cimgui::ImTriangleArea(cimgui::ImVec2 a, cimgui::ImVec2 b, cimgui::ImVec2 c)
{
    return ::ImTriangleArea(ConvertToCPP_ImVec2(a), ConvertToCPP_ImVec2(b), ConvertToCPP_ImVec2(c));
}

CIMGUI_API bool   cimgui::ImTriangleIsClockwise(cimgui::ImVec2 a, cimgui::ImVec2 b, cimgui::ImVec2 c)
{
...
CIMGUI_API size_t cimgui::ImBitArrayGetStorageSizeInBytes(int bitcount)
{
    return ::ImBitArrayGetStorageSizeInBytes(bitcount);
}

CIMGUI_API void   cimgui::ImBitArrayClearAllBits(ImU32* arr, int bitcount)
{
    ::ImBitArrayClearAllBits(arr, bitcount);
}

CIMGUI_API bool   cimgui::ImBitArrayTestBit(const ImU32* arr, int n)
{
    return ::ImBitArrayTestBit(arr, n);
}

CIMGUI_API void   cimgui::ImBitArrayClearBit(ImU32* arr, int n)
{
    ::ImBitArrayClearBit(arr, n);
}

CIMGUI_API void   cimgui::ImBitArraySetBit(ImU32* arr, int n)
{
    ::ImBitArraySetBit(arr, n);
}

CIMGUI_API void   cimgui::ImBitArraySetBitRange(ImU32* arr, int n, int n2)
{
...
CIMGUI_API cimgui::ImGuiStoragePair* cimgui::ImLowerBound(cimgui::ImGuiStoragePair* in_begin, cimgui::ImGuiStoragePair* in_end, ImGuiID key)
{
...
CIMGUI_API const cimgui::ImFontBuilderIO* cimgui::ImFontAtlasGetBuilderForStbTruetype(void)
{
...
CIMGUI_API void cimgui::ImFontAtlasUpdateSourcesPointers(cimgui::ImFontAtlas* atlas)
{
    ::ImFontAtlasUpdateSourcesPointers(reinterpret_cast<::ImFontAtlas*>(atlas));
}

CIMGUI_API void cimgui::ImFontAtlasBuildInit(cimgui::ImFontAtlas* atlas)
{
    ::ImFontAtlasBuildInit(reinterpret_cast<::ImFontAtlas*>(atlas));
}

CIMGUI_API void cimgui::ImFontAtlasBuildSetupFont(cimgui::ImFontAtlas* atlas, cimgui::ImFont* font, cimgui::ImFontConfig* src, float ascent, float descent)
{
...
CIMGUI_API void cimgui::ImFontAtlasBuildPackCustomRects(cimgui::ImFontAtlas* atlas, void* stbrp_context_opaque)
{
    ::ImFontAtlasBuildPackCustomRects(reinterpret_cast<::ImFontAtlas*>(atlas), stbrp_context_opaque);
}

CIMGUI_API void cimgui::ImFontAtlasBuildFinish(cimgui::ImFontAtlas* atlas)
{
    ::ImFontAtlasBuildFinish(reinterpret_cast<::ImFontAtlas*>(atlas));
}

CIMGUI_API void cimgui::ImFontAtlasBuildRender8bppRectFromString(cimgui::ImFontAtlas* atlas, int x, int y, int w, int h, const char* in_str, char in_marker_char, unsigned char in_marker_pixel_value)
{
...
CIMGUI_API void cimgui::ImFontAtlasBuildRender32bppRectFromString(cimgui::ImFontAtlas* atlas, int x, int y, int w, int h, const char* in_str, char in_marker_char, unsigned int in_marker_pixel_value)
{
...
CIMGUI_API void cimgui::ImFontAtlasBuildMultiplyCalcLookupTable(unsigned char out_table[256], float in_multiply_factor)
{
    ::ImFontAtlasBuildMultiplyCalcLookupTable(out_table, in_multiply_factor);
}

CIMGUI_API void cimgui::ImFontAtlasBuildMultiplyRectAlpha8(const unsigned char table[256], unsigned char* pixels, int x, int y, int w, int h, int stride)
{
    ::ImFontAtlasBuildMultiplyRectAlpha8(table, pixels, x, y, w, h, stride);
}

CIMGUI_API void cimgui::ImFontAtlasBuildGetOversampleFactors(const cimgui::ImFontConfig* src, int* out_oversample_h, int* out_oversample_v)
{
    ::ImFontAtlasBuildGetOversampleFactors(reinterpret_cast<const ::ImFontConfig*>(src), out_oversample_h, out_oversample_v);
}

CIMGUI_API bool cimgui::ImFontAtlasGetMouseCursorTexData(cimgui::ImFontAtlas* atlas, ImGuiMouseCursor cursor_type, cimgui::ImVec2* out_offset, cimgui::ImVec2* out_size, cimgui::ImVec2 out_uv_border[2], cimgui::ImVec2 out_uv_fill[2])
{
...
CIMGUI_API void        cimgui::ImGuiTestEngineHook_ItemAdd(cimgui::ImGuiContext* ctx, ImGuiID id, cimgui::ImRect bb, const cimgui::ImGuiLastItemData* item_data)
{
...
CIMGUI_API void        cimgui::ImGuiTestEngineHook_ItemInfo(cimgui::ImGuiContext* ctx, ImGuiID id, const char* label, ImGuiItemStatusFlags flags)
{
    ::ImGuiTestEngineHook_ItemInfo(reinterpret_cast<::ImGuiContext*>(ctx), id, label, flags);
}

CIMGUI_API void        cimgui::ImGuiTestEngineHook_Log(cimgui::ImGuiContext* ctx, const char* fmt, ...)
{
    va_list args;
    va_start(args, fmt);
...
CIMGUI_API const char* cimgui::ImGuiTestEngine_FindItemDebugLabel(cimgui::ImGuiContext* ctx, ImGuiID id)
{
