...
#define _SETTINGS($, COLUMN, RENAME)                                                   \
    ...
    COLUMN($, style_accent, .type = "TEXT", .dflt = "'{accent}'") /* FIXME */          \
    COLUMN($, style_alt_bg, .type = "TEXT", .dflt = "'{alt_bg}'") /* FIXME */          \
    COLUMN($, style_bg, .type = "TEXT", .dflt = "'{bg}'") /* FIXME */                  \
    COLUMN($, style_border, .type = "TEXT", .dflt = "'{border}'") /* FIXME */          \
    COLUMN($, style_corner_radius, .type = "INTEGER", .dflt = "6") /* FIXME */         \
    COLUMN($, style_text, .type = "TEXT", .dflt = "'{text}'") /* FIXME */              \
    COLUMN($, style_text_dim, .type = "TEXT", .dflt = "'{text_dim}'") /* FIXME */      \
